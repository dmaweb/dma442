# dma442 will get you set up with a basic local development workflow. It installs a self-enclosed, self-running web server with BrowserSync and Sass processing.
